class Map{
	...
	constructor(scene,key,tileSetName,floorLayer,blockedLayerName)
	{
	...
	createMap(){
		...
		this.floorLayer = this.map.createStaticLayer(this.floorLayer, this.tiles, 0, 0);
		this.floorLayer.setScale(1.5);
